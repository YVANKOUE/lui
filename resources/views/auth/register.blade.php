...
<div class="login-signup">
    ...
    <form class="form text-center" method="POST" action="{{ route('register') }}" id="register_form">
        ...
        <div class="form-group">
            <select id="role" class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('role') is-invalid @enderror" type="text" placeholder="Role" name="role" value="{{ old('role') }}" required autocomplete="role" />
